...
type _FormatCreate FormatCreate
...
func (o *FormatCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varFormatCreate := _FormatCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFormatCreate)

	if err != nil {
		return err
	}

	*o = FormatCreate(varFormatCreate)
